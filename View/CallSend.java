...
public class CallSend extends javax.swing.JFrame {
    private Clip clip;
    private Socket clientSocket;
    private ShareData shareData;
    private ReentrantLock lock;
    private Dto receivedObject;
    public CallSend(Socket clientSocket,ShareData shareData,ReentrantLock lock,Dto receivedObject) {
        ...
        playRingtone();
        initComponents();
        jLabel1.setText("đang gọi "+receivedObject.getBody().get("conservationID").toString());
    }
    ...
    private void initComponents() {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                stopRingtone(); // Dừng âm thanh trước khi đóng cửa sổ
                dispose(); // Đóng cửa sổ
            }
        });
